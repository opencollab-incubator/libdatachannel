...
typedef struct {
	...
	int portRangeBegin;      // 0 means automatic, otherwise 1-65535
	int portRangeEnd;        // 0 means automatic, otherwise 1-65535
...
// Prefer this factory when an listener already owns the shared UDP socket.
